...
exports.generateUuid = () => 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, (c) => {
  /* eslint-disable */
...
exports.getFilePath = fullPath => fullPath.substring(0, fullPath.lastIndexOf('/'));
...
exports.randomNumber = (len, charSetInput) => {
  const charSet = charSetInput || '0123456789';
  let randomString = '';
  for (let i = 0; i < len; i++) {
    const randomPoz = Math.floor(Math.random() * charSet.length);
    randomString += charSet.substring(randomPoz, randomPoz + 1);
 ...
 */
exports.replaceSpecialChars = (str, char = '_') => {
...
exports.truncate = (str, length = 100) => (str.length > length ? `${str.substring(0, length - 3)}...` : str);
