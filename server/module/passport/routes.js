...
module.exports = (router) => {
   ...
   * @apiGroup Auth
   * @apiVersion 1.0.0
   * @api {post} /v1/auth/company/login  Company login
   * @apiDescription Login with email and password
   * @apiParam {String}   email      email address
   * @apiParam {String}   password   password
   * @apiSuccessExample {json} Success-Response:
   ...
   * @apiGroup Auth
   * @apiVersion 1.0.0
   * @api {post} /v1/auth/company/login  Driver login
   * @apiDescription Login with email and password
   * @apiParam {String}   email      email address
   * @apiParam {String}   password   password
   * @apiSuccessExample {json} Success-Response:
   ...
   * @apiParam {String}   email      email address
   * @apiParam {String}   [type] `user`, `driver`, `company`. Default is `user`
   * @apiSuccessExample {json} Success-Response:
   *  {
   *     "code": 200,
   *     "message": "OK",
