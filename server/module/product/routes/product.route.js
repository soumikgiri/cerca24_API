...
module.exports = (router) => {
   ...
   * @apiParam {Number} [weight] wight in kg or litre
   * @apiParam {String} [weightType] `kg`, `litre`
   * @apiParam {String} [volume] cubic meters
   ...
   * @apiGroup Product
   * @apiVersion 1.0.0
   * @api {get} /v1/products/export/csv?:name&brandId&:shopId&&:q&dailyDeal&discounted&bestSell&soldOut&:sort&:sortType Export csv
   * @apiDescription Get list products
   * @apiParam {String}   [name]      product name
   * @apiParam {String}   [shortDescription]      product description
   * @apiParam {String}   [q] search all allowed fields
