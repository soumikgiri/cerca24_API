...
module.exports = (router) => {
   ...
   * @apiVersion 1.0.0
   * @apiName Get list
   * @api {get} /v1/payout/requests/export/csv?:shopId&startDate&toDate&fileName Export csv
   * @apiParam {String} [shopId] custom shop Id
   ...
   */
  router.get(
    '/v1/payout/requests/export/csv',
    Middleware.isAuthenticated,
    Middleware.hasRole('admin'),
    requestController.toCsv
  );
};