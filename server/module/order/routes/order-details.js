...
module.exports = (router) => {
   ...
   * @apiParam {Object}   [pickUpAddressObj] Pick up adderss of shop
   ...
   * @apiGroup Shop Order
   * @apiVersion 1.0.0
   * @api {get} /v1/orders/detail/tracking/:trackingCode Get details of the order by code
   * @apiDescription Get details of the order
   */
  router.get(
    '/v1/orders/detail/tracking/:trackingCode',
    orderDetailsController.tracking,
    Middleware.Response.success('details')
  );
};
