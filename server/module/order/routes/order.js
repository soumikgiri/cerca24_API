...
module.exports = (router) => {
   ...
   * @apiGroup Order
   * @apiVersion 1.0.0
   * @api {get} /v1/orders/tracking/:trackingCode Get details of the order by code
   * @apiDescription Get details of the order
   */
  router.get(
    '/v1/orders/tracking/:trackingCode',
    orderController.details,
    Middleware.Response.success('order')
  );
   ...
   * @apiGroup Order
   * @apiVersion 1.0.0
   * @api {get} /v1/orders/tracking/:trackingCode/paymentStatys Get payment status
   * @apiDescription Get details of the order
   */
  router.get(
    '/v1/orders/tracking/:trackingCode/paymentStatus',
    orderController.getPaymentStatus,
    Middleware.Response.success('status')
  );
};
